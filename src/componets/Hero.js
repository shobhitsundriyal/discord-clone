...
function Hero() {
	...
	return (
		<div className='bg-discord_blue pb-8 lg:pb-0 max-w-100 max-h-full overflow-hidden'>
			<div className='p-7 py-9 h-87vh w-full md:flex relative lg:justify-center sm:overflow-hidden'>
            ...
            focus:outline-none transition ease-in-out duration-500 z-10'
               ...
               lg:block lg:bottom-0 lg:-left-16
               md:hidden'
						/>
						...
						<img
							src={heroImg2}
							alt='img2'
							className='hidden md:inline absolute opacity-80 right-2 md:bottom-0 lg:-right-16 md:-right-12'
						/>
					</div>
				</div>
			</div>
